...
public class ParserTest {
	...
	@Before
	public void setUp() {
		p = new Parser(context);
	}

	private void resetParser() throws Exception {
...
//	}
	...
	public void testPatterns() throws Exception {
		...
		assertTrue(e.getAction().getGuid().equals(EntityGuid.Restore.getGuid()));
		...
		assertTrue(e.getEffect().getGuid().equals(EntityGuid.Damage.getGuid()));
		assertEquals(Integer.valueOf(843), e.getValue());
		assertTrue(e.getDamage().getGuid().equals(EntityGuid.Energy.getGuid()));
		assertTrue(e.getMitigation().getGuid().equals(EntityGuid.Shield.getGuid()));
