...
public class DreadFortress extends Raid {
	...
	private String getNewPhaseNameForBrontes(final Event e, final String currentPhaseName) {
		...
		if (!PHASE_BRONTES_FINGERS.equals(currentPhaseName)
			&& (Helpers.isTargetWithin(e, 3303289412124672L, 3303276527222784L) // Finder, Hand
				|| Helpers.isSourceWithin(e, 3303289412124672L, 3303276527222784L))) {
		...
		if (PHASE_BRONTES_HANDS.equals(currentPhaseName)
			&& (Helpers.isTargetOrSourceWithin(e, BRONTES_BOSS_SM_8M, BRONTES_BOSS_SM_16M, BRONTES_BOSS_HM_8M, BRONTES_BOSS_HM_16M, 3309040373334016L)) // Kephess
			&& e.getValue() != null) {
			// Kephess appears
	...
	public static class BrontesBurnChallenge extends CombatChallenge {
		public BrontesBurnChallenge() {
			super(RaidChallengeName.BrontesBurn,
				...
				Arrays.asList(new Object[]{BRONTES_BOSS_SM_8M, BRONTES_BOSS_SM_16M, BRONTES_BOSS_HM_8M, BRONTES_BOSS_HM_16M,
