...
public interface EventService {
	...
	void flushEvents(List<Event> events,
			...
			Map<Actor, Parser.ActorState> actorStates) throws Exception;
	...
	CombatStats getCombatStats(List<Combat> combat, CombatSelection combatSel, String playerName) throws Exception;
	...
	List<DamageDealtStats> getDamageDealtStats(Combat combat, boolean byTargetType, boolean byTargetInstance, boolean byAbility, CombatSelection combatSel, String playerName) throws Exception;
	...
	List<DamageTakenStats> getDamageTakenStats(Combat combat, boolean bySourceType, boolean bySourceInstance, boolean byAbility, CombatSelection combatSel, String playerName) throws Exception;
