...
public class ChangelogDialogPresenter extends BaseDialogPresenter {
	...
	private static final String CHANGELOG_TEXT0 = "Version 1.3 (2018-08-03) - Minor release\n\n"
		+ "- Scyva & Izax support added\n"
		+ "- May do more updates in a foreseeable future, fingers crossed\n"
		+ "\n"
		;

	private static final String CHANGELOG_TEXT = "Version 1.2 (2017-04-10) - 5.2 compatibility, Overlays fix\n\n"
		+ "- 5.2 support, namely the Iokath/Tyth encounter\n"
		+ "- Attempt to solve the pesky 'overlays-make-taskbar-visible-in-windows-10' bug\n"
		+ "\n"
		;

	private static final String CHANGELOG_TEXT2 = "Version 1.1 (2016-04-27) - Raid Notes, Challenges Leaderboard and more\n\n"
	...
	public ChangelogDialogPresenter() {
		...
		content.getChildren().add(new Label(CHANGELOG_TEXT));
